...
class StreamServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamData = channel.unary_stream(
                '/computation.StreamService/StreamData',
...
def add_StreamServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'computation.StreamService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('computation.StreamService', rpc_method_handlers)
